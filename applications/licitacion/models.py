...
class Licitacion(models.Model):
    ...
    solicitante = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="solicitante_rela", on_delete=models.CASCADE)
    trabajador = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="trabajador_rela", on_delete=models.CASCADE)
